                            ...
                            <table class="w-full divide-y divide-gray-300">
                                ...
                                @foreach ($posts as $post)
                                    <tr class="even:bg-gray-50" wire:key="{{ $post->id }}">
										...
										<td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">{{ $post->nombre }}</td>
										<td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">{{ $post->apellido }}</td>
										<td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">{{ $post->edad }}</td>
										<td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">{{ $post->cedula }}</td>
